...
#    lines=$(sort $HOST_FILE_PATH|uniq|wc -l)
  ...
  echo "reachhere-s"
  time mpirun --mca btl_tcp_if_include eth0 --allow-run-as-root -np ${AWS_BATCH_JOB_NUM_NODES} --hostfile supervised-scripts/combined_hostfile ./opensmt-1/build/src/bin/opensmt opensmt-1/regression/QF_UF/iso_brn029_simplified_1b.smt2
  echo "reachhere-e"
